...
@Component({
  selector: 'app-new-customer-reg-details',
  templateUrl: './new-customer-reg-details.page.html',
  styleUrls: ['./new-customer-reg-details.page.scss'],
})
export class NewCustomerRegDetailsPage implements OnInit {
